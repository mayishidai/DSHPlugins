...
const bundleCode = `window.__ModuleLoader__.load({
...
const outputFile = join(__dirname, 'client', 'client.js');

mkdirSync(dirname(outputFile), { recursive: true });
writeFileSync(outputFile, bundleCode.trim());
console.log('✓ Generated:', outputFile);
console.log('  Size:', bundleCode.length, 'bytes');
